...
data_2d = generate_ds(result_2d, mean_2d, best_2d, sigma_2d, sphere_cec, result_2d$par) %>%
  dplyr::mutate(dim = "2")
data_10d = generate_ds(result_10d, mean_10d, best_10d, sigma_10d, sphere_cec, result_10d$par) %>%
  dplyr::mutate(dim = "10")
