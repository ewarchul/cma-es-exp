...
data_2d = generate_ds(result_2d, mean_2d, best_2d, sigma_2d, sphere_cec, c(-21.98481, 11.55500)) %>%
  dplyr::mutate(dim = "2")
data_10d = generate_ds(result_10d, mean_10d, best_10d, sigma_10d, sphere_cec, c(-21.98481, 11.55500, -36.01068,  69.37273, -37.60887, -48.53629,  53.76477,  13.71857,  69.82859, -18.62781)) %>%
  dplyr::mutate(dim = "10")
